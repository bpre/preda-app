    ...
    public function down(): void
    {
        ...
        Schema::table('sentences', function (Blueprint $table) {
            foreach ([
                ...
                if (Schema::hasColumn('sentences', $column)) {
