...
class TaskCreated extends Notification implements AsFilamentNotification
{
    use Queueable;
    ...
    public static function toFilamentNotification(): FilamentNotification
    {
        return FilamentNotification::make()
            ->message(fn (self $notification) => "Masz nowe zadanie")
            ...
            Od: {$notification->task->task_creator->name}
            "
