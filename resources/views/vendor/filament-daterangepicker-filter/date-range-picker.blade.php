@php
    ...
    // The plugin renders the calendar icon as a "clear" suffix action by default.
    // In this project the icon should behave as the picker trigger.
    $suffixActions = [];
    $suffixIcon ??= $getIcon();
@endphp
...
>
    ...
    >
        ...
        <x-filament::input.wrapper
            ...
            :attributes="\Filament\Support\prepare_inherited_attributes($getExtraAttributeBag())->merge([
                'x-ref' => 'trigger',
                'x-on:focus-input.stop' => 'openPicker()',
            ])"
        >
            <div
