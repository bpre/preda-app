  ...
  <body tabindex="1">
    <div id="outerContainer">
      ...
      <div id="mainContainer">
        <div class="hidden findbar doorHanger" id="findbar">
        ...
        <div class="hidden editorParamsToolbar doorHangerRight" id="editorFreeTextParamsToolbar">
        ...
        <div class="hidden editorParamsToolbar doorHangerRight" id="editorInkParamsToolbar">
          <div class="editorParamsToolbarContainer">
            <div class="editorParamsSetter">
        ...
        <div id="secondaryToolbar" class="hidden secondaryToolbar doorHangerRight">
