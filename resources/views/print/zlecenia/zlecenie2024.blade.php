    ...
    <div style="page-break-after: always;">
        <div style="border-top:1px solid #000" class="mt-5">
            ...
            <dl>
                ...
                <dt>1.1.</dt>
                <dd>
                    Klient zleca Kancelarii świadczenie usług prawnych w zakresie dochodzenia od banku roszczeń wynikających z opisanej wyżej umowy {{ $pozyczka ? 'pożyczki' : 'kredytowej' }} (ustalenia nieważności umowy, ustalenia bezskuteczności poszczególnych postanowień umowy{{ $is_getin ? '' : ', zasądzenia zwrotu świadczeń zapłaconych nienależnie bankowi' }}).
                </dd>
                <dt>1.2.</dt>
                <dd>
                    Zakres objętych niniejszą umową usług obejmuje:
                    <br class="mt-5">
                    <strong>Etap I</strong>: przygotowanie wniosku do banku o wydanie zaświadczenia, w przypadku niewydania przez bank zaświadczenia w terminie - przygotowanie na wniosek klienta reklamacji, {{ $is_getin ? 'ustalenie sumy dokonanych spłat' : 'oszacowanie roszczeń w związku z nieważnością umowy oraz bezskutecznością poszczególnych jej postanowień' }}, przygotowanie i wysłanie do banku przedsądowego wezwania, przygotowanie i złożenie pozwu, reprezentowanie Klienta przed sądem I instancji, przygotowywanie dalszych pism procesowych po wniesieniu pozwu;
                    <br class="mt-5">
            ...
            @if($e->is_bonus)
                <dl>
                    ...
                    <dd>
                        ...
                        @if(false)
                            <strong>{{ $e->bonus_percent }}%</strong> kwoty {{ $pozyczka ? 'pożyczki' : 'kredytu' }} (określonej w umowie lub aneksie do umowy), jednak nie niższej niż <strong>{{ bp_currency($e->bonus_minimum) }}</strong>.
                        @else
            ...
            <!-- 5 -->
            <dl>
                <dt class="bold">5.</dt><dd class="heading">Wynagrodzenie za rozprawy.</dd>
                <dt></dt>
                <dd>
            ...
            <dl>
                ...
                <dt>6.1.</dt>
                <dd>
                    W sprawach prowadzonych na podstawie niniejszej umowy koszty zastępstwa procesowego zasądzone prawomocnie od banku lub wynikające z ugody stanowią w całości dodatkowe wynagrodzenie Kancelarii – w wysokości wynikającej z wyroków, postanowień lub z treści ugody.
                </dd>
