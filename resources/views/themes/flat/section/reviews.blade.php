...
@else
    ...
    <div class="mx-auto">
        ...
        <div class="hidden items-start gap-5 sm:grid xl:hidden sm:grid-cols-2">
        ...
        <div class="hidden items-start xl:grid xl:grid-cols-3 xl:gap-5">
